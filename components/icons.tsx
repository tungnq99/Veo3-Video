...
// Using a simple re-export for icons to keep it clean.
// In a larger app, you might create custom wrapped components.
// For this project, this avoids installing the full library in the final environment.
import React from 'react';

// A type for icon props
...
export const RectangleHorizontal: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="2" y="7" width="20" height="10" rx="2"/></svg>
);

export const RectangleVertical: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="7" y="2" width="10" height="20" rx="2"/></svg>
);
